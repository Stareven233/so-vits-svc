...
class SoVITSModel:
    ...
    _preprocess_form = {
        ...
        "use_old_preprocess": {
            "type": "checkbox",
            "default": False,
            "label": I.sovits.preprocess.use_old_preprocess_label,
            "info": I.sovits.preprocess.use_old_preprocess_info,
        },
        ...
        "debug": {
            "type": "checkbox",
            "default": False,
            "label": I.sovits.preprocess.debug_label,
            "info": I.sovits.preprocess.debug_info,
        },
    }
    ...
    def train(self, params, progress):
        # print(params)
    ...
    def preprocess(self, params, progress=gr.Progress()):
        ...
        if params["use_old_preprocess"]:
            ...
            cmd = f"{executable} -m SoVITS.preprocess_chunk_by_steps --f0_predictor {params['f0']}"
        if params["use_diff"]:
            cmd += " --use_diff"
        if bool(os.environ.get("H0_DEV", False)) or params["debug"]:
            cmd += " --debug"
        exec(cmd)
        return I.sovits.finished

    def infer(self, params, progress):
